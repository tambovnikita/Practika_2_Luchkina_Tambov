...
class FormInfo(QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        self.teInfo3.setHtml(
            "<font color='black' size='5' style='white-space: pre-wrap'>3.    Проверяем начальное базисное решения на опорность (принадлежность ОДР)\n   3.1    Условие неотрицательности не "
            ...
            "Критерий оптимальности: если среди оценок переменных относительно выбранного базиса D в задаче максимизации нет отрицательных"
            "(в задаче минимизации нет положительных), то полученное базисное решение оптимально (Таблица № 2)"
            "Замечание: оценки базисных переменных всегда равны 0."
            "Если решение не оптимально (отрицательные оценки есть), то переходим к смежной точке."
            "Смежные точки отличаются одной базисной и одной свободной переменной."
        )
